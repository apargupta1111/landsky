          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 border-b border-[var(--panel-border)] bg-[var(--bg-color)]/30 backdrop-blur-md">
              ...
              <div className="flex items-center space-x-4 w-full md:w-auto">
                <div className="flex items-center bg-black/10 dark:bg-white/10 rounded-full px-4 py-2 w-full md:w-72 border border-[var(--panel-border)] focus-within:border-primary transition-colors">
                ...
                <button 
                  onClick={onClose}
                  className="p-2 rounded-full bg-black/5 dark:bg-white/5 hover:bg-error/20 hover:text-error transition-colors text-[var(--text-secondary)] border border-[var(--panel-border)]"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
            ...
            {/* Grid List */}
            <div className="flex-1 overflow-y-auto p-6 scrollbar-hide bg-[var(--bg-color)]/10">
